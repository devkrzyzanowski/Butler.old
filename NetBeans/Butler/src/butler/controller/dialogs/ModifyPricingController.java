 ...
 */
public class ModifyPricingController extends DialogBox implements Initializable  {
    private Booking booking;
    @FXML private Label label;
    @FXML ComboBox<Legend> selectStatusComboBox;
    private IonPricing ion;
    private Model model;    
    
    public ModifyPricingController() {
    ...
    public void init(Booking booking, IonPricing ion) {
        this.ion = ion;
